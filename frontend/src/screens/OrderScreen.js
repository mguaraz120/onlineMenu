...
const OrderScreen = ({match, history}) => {
    ...
    }, [dispatch, successPay, order, orderId, successDeliver, history, userInfo])
                ...
                <Col md={8}>
                    <ListGroup >
                        <ListGroupItem>
                            ...
                            {order.isPaid 
                            ? 
                            <Message variant='success'>Food is Paid</Message>
                            : 
                            <Message variant='danger'>Food is Not Paid</Message>
                            }

                            {order.isDelivered 
                            ? 
                            <Message variant='success'> Let's eat! Food is Ready </Message>
                            : 
